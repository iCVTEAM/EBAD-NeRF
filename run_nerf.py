...
def config_parser():
    ...
    parser.add_argument("--barf_start", type=float, default=0.1,
                        help='barf start')
    parser.add_argument("--barf_end", type=float, default=0.5,
                        help='barf start')
    ...
    # model
    parser.add_argument("--model", type=str, default="liner",
                        help='event, linear, cubic')
    ...
    # event options
    parser.add_argument("--use_event", type=bool, default=False,
                        help='use event to help the training')
    parser.add_argument("--bin_num", type=int, default=4,
